...
pub fn get_checks() -> Vec<Check> {
    vec![
        ...
        Check::new("archaism.boughten", "'boughten' is archaic.", r"\bboughten\b").raw(),
        ...
        Check::new("archaism.camarade", "'camarade' is archaic.", r"\bcamarade\b").raw(),
        Check::new("archaism.chiefer", "'chiefer' is archaic.", r"\bchiefer\b").raw(),
        Check::new("archaism.chiefest", "'chiefest' is archaic.", r"\bchiefest\b").raw(),
        Check::new("archaism.christiana", "'Christiana' is archaic.", r"\bChristiana\b").raw(),
        Check::new("archaism.completely_obsolescent", "'completely obsolescent' is archaic.", r"completely obsolescent"),
        Check::new("archaism.cozen", "'cozen' is archaic.", r"\bcozen\b").raw(),
        Check::new("archaism.divers", "'divers' is archaic. Use 'diverse' or 'various'.", r"\bdivers\b").raw(),
        Check::new("archaism.deflexion", "'deflexion' is archaic. Use 'deflection'.", r"\bdeflexion\b").raw(),
        Check::new("archaism.durst", "'durst' is archaic.", r"\bdurst\b").raw(),
        Check::new("archaism.fain", "'fain' is archaic.", r"\bfain\b").raw(),
        Check::new("archaism.forsooth", "'forsooth' is archaic.", r"\bforsooth\b").raw(),
        Check::new("archaism.foreclose_from", "'foreclose from' is archaic. Use 'foreclose on'.", r"foreclose from"),
        Check::new("archaism.forewent", "'forewent' is archaic.", r"\bforewent\b").raw(),
        Check::new("archaism.haply", "'haply' is archaic.", r"\bhaply\b").raw(),
        Check::new("archaism.howbeit", "'howbeit' is archaic.", r"\bhowbeit\b").raw(),
        Check::new("archaism.illumine", "'illumine' is archaic. Use 'illuminate'.", r"\billumine\b").raw(),
        ...
        Check::new("archaism.methinks", "'methinks' is archaic.", r"\bmethinks\b").raw(),
        Check::new("archaism.nigh", "'nigh' is archaic. Use 'near' or 'nearly'.", r"\bnigh\b").raw(),
        Check::new("archaism.peradventure", "'peradventure' is archaic.", r"\bperadventure\b").raw(),
        Check::new("archaism.perchance", "'perchance' is archaic. Use 'perhaps'.", r"\bperchance\b").raw(),
        Check::new("archaism.saith", "'saith' is archaic.", r"\bsaith\b").raw(),
        Check::new("archaism.shew", "'shew' is archaic. Use 'show'.", r"\bshew\b").raw(),
        ...
        Check::new("archaism.inforce", "'inforce' is archaic. Use 'enforce'.", r"\binforce\b").raw(),
